...
import { SplashScreen,WelcomeScreen,SigninScreen, SignupScreen, ForgotPasswordScreen ,RegisterPhoneScreen,ChangePasswordScreen, EmailVerificationScreen} from "../screens";
...
const Navigators = ()=>
{
    return(<NavigationContainer >
            <Stack.Navigator screenOptions={{headerShown:false}}>
                ...
                <Stack.Screen name = "EmailVerificationScreen" component ={EmailVerificationScreen}></Stack.Screen>
