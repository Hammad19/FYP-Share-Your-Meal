    ...
    marginRight: 20,
      ...
      <View style={styles.userInfoSection}>
        ...
        <View style={styles.row}>
          ...
          <Text style={{color:"#777777", marginLeft: 20}}>+923112793726</Text>
        </View>
        <View style={styles.row}>
          <Icon name="email" color="#777777" size={20}/>
          <Text style={{color:"#777777", marginLeft: 20}}>{auth.user.email}</Text>
        </View>
      </View>
      ...
      <View style={styles.menuWrapper}>
        ...
        <TouchableRipple onPress={() => {}}>
          <View style={styles.menuItem}>
            <Icon name="settings-outline" color={Colors.DEFAULT_GREEN} size={25}/>
